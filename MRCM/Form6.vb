...
Public Class Form6
    ...
    Private Sub Form6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the '_MRCM1_0DataSet.doctorsre' table. You can move, or remove it, as needed.
        Me.DoctorsreTableAdapter.Fill(Me._MRCM1_0DataSet.doctorsre)
        con.ConnectionString = dbProvider & dbSource
        con.Open()
        cmd = New OleDbDataAdapter("SELECT * FROM doctorsre", con)
        cmd.Fill(dt)
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        Dim q As String = "SELECT * FROM doctorsre WHERE Name LIKE '%" & TextBox1.Text & "%' OR DoctorID LIKE '%" & TextBox1.Text & "%'"
